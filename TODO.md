...
- [ ] **고정 댓글 수동 고정** — API 미지원. 새로 단 2건(오디세이아·왜 칸트인가)은 Studio 에서 고정 필요
- [ ] **고정 댓글 없는 나머지 63편** — `25_batch_add_pinned_comments.py --apply` 로 일괄 가능하나
      공개 게시가 63건이라 별도 판단 필요 (쿼터 약 3,150 units)
