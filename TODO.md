...
- [ ] 🔴 **레디메이드 인생** (채만식, 1,119) — **NLM 비디오만 남음.**
      3회 연속 60분 타임아웃으로 실패 → 내일 재시도(사용자 결정).
      나머지(요약·TTS·이미지 77장·썸네일·렌더 스크립트)는 GPU150에 준비 완료.
      상세는 `data/inflight_레디메이드인생.md`
- [ ] 그다음 — 기억 속의 들꽃(윤흥길, 1,496). 2회 측정 일치·중복 0건
