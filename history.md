...
- ★ **"3회 동일 = 안정"은 안전한 판정이 아니다.** 9/13 에 3회 연속 3,994 로 나와
  안정 그룹으로 적어뒀는데, 사흘 뒤 4회 측정에서 한 번도 3,994 가 나오지 않았다.
  수난이대·우상의 눈물처럼 **다른 날짜에 재현되는 것**이 안정의 기준이고,
  같은 세션 안의 연속 동일값은 그 근거가 되지 못한다
