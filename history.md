...
- ⚠️ **다만 순이 삼촌·독 짓는 늙은이·모래톱 이야기는 제안어가 1~2개뿐**이다.
  의도 비율 1.00 은 표본이 1~2개라는 뜻이라 신뢰도가 낮고, 스크립트도 「수요희박」으로
  판정한다. 네이버 수요(1,350/520/350)는 실재하므로 게이트는 통과하지만,
  **착수 전에 제안어를 눈으로 확인**해야 한다
