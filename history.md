...
### 다음 우선 실행 액션
> ★ **9/14(월) 18:00 「수난이대」 공개 — 사용자에게 알리기로 약속했다** (9/12 요청).
> 18:05 시스템 cron 이 `data/publish_check_latest.md` 를 남긴다. 세션이 살아 있으면
> 18:12 one-shot cron 이 알린다. 세션이 끊겼다면 **이 줄을 본 세션이 즉시 보고**하고 줄을 지운다.
