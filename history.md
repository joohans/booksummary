...
### 채널 현황
- 채널 영상 **496편**. 예약 큐 **28편**, 꼬리 **12/15 홍계월전**. 다음 빈 슬롯은 **12/18**
...
2. **2026-09-21 재공급 완료 — 1순위 「박씨전」**(받을 수 있는 수요 644).
   ...
   ★ 다음 편 1순위는 **만복사저포기(305)**, 그다음 **정수정전(275)**.
...
## 2026-09-24 (3) — 「만복사저포기」(김시습) 제작 중 — 렌더 진행 중

⏳ **업로드 전 상태.** 요약 TTS 4:51 · NLM 7:33 · 렌더 12:27 진행 중. 공개 예약 예정 12/18(금) 18:00 KST.
